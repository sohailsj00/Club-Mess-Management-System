...
if ($result1->num_rows > 0) {
    ...
    echo "</table>";
                    ...
                    echo "<table><tr><th>Month Name</th><th>Due Date</th><th>Amount</th><th>Payment Status</th></tr>";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if ($date1 > $date2Formatted) 
                            {
                                ...
                                $memberid = $var;
                                echo "<tr><td><a href='Monthly_payment_details.php?month=".$mahina."&memberid=".$memberid."' style='color: #dc3545;'>".$mahina."</a></td><td>".$Due_Date."</td><td>".$AMOUNT."</td><td>".$payment_status."</td></tr>";
                            }
                        }
                   }
                        echo "</table>";
